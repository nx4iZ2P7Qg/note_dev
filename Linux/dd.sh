...
# 测试硬盘速度，写
dd if=/dev/zero bs=1k count=10000000 of=1Gb.file
# 在命令前加上time，可以计算命令运行时间
...
# 注意：指定数字的地方若以下列字符结尾乘以相应的数字：b=512, c=1, k=1024, w=2, xm=number m，kB=1000，K=1024，MB=1000*1000，
