...
//    int int2 = 010;
        ...
        // 从字符转
        System.out.println(Size.valueOf(Size.class, "SMALL")); // Size.SMALL
        // 全部常量
        ...
        // jvm使用以上标识选择正确的方法执行
        // 获取Class，方法一
        System.out.println(new String().getClass()); // class java.lang.String
        // 获取Class，方法二
        try {
            Class c = Class.forName("java.util.Date");
            System.out.println(c); // class java.util.Date
